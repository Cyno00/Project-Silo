...
function listClick(elmt) {
	...
	var id = elmt.id;
	if (id === "apple") {
		result.innerHTML = 'Apple devices can be recyceld via Apple Trade In, where store credit <br> can be given: <a href="https://www.apple.com/shop/trade-in"> Link </a> <br> <br> There are also many other providers that will accept your device.';
	}
	else if (id === "samsung") {
